...
func Test_supportsControllerCreateNfsExport(t *testing.T) {
	tests := []struct {
		name         string
			...
			output: &csi.ControllerGetCapabilitiesResponse{
				Capabilities: []*csi.ControllerServiceCapability{
					...
					},
					{
						Type: &csi.ControllerServiceCapability_Rpc{
							Rpc: &csi.ControllerServiceCapability_RPC{
								Type: csi.ControllerServiceCapability_RPC_CREATE_DELETE_NFSEXPORT,
							},
						},
					},
				},
	...
	for _, test := range tests {
		...
		ok, err := supportsControllerCreateNfsExport(context.Background(), csiConn)
