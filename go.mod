module github.com/kubernetes-csi/external-nfsexporter/v6
...
require (
	...
	github.com/kubernetes-csi/external-nfsexporter/client/v6 v6.0.1
...
replace (
	github.com/kubernetes-csi/external-nfsexporter/client/v6 => ./client
